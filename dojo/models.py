...
class System_Settings(models.Model):
    ...
    delete_duplicates = models.BooleanField(default=True, blank=False, help_text=_("Requires next setting: maximum number of duplicates to retain."))
    max_dupes = models.IntegerField(blank=True, null=True, default=0,
